...
Route::get('/lectureredit/{id}','Admin\LecturerCrudController@lectureredit');
Route::put('/lecturereditsave/{id}','Admin\LecturerCrudController@update');
Route::get('/lecturerdelete/{id}','Admin\LecturerCrudController@destroy');